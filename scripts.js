        ...
        function openEditPanel(toolId) {
            ...
            // Update icon preview
            document.querySelector('.icon-preview .material-icons').textContent = tool.icon;
        ...
        function openNewToolPanel() {
            ...
            // Update icon preview
            document.querySelector('.icon-preview .material-icons').textContent = 'dashboard';
        ...
        document.getElementById('toolIcon').addEventListener('input', function() {
            document.querySelector('.icon-preview .material-icons').textContent = this.value;
        });
